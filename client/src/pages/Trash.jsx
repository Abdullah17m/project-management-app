...
const Trash = () => {
  ...
  const { data, isLoading, refetch } = useGetAllTasksQuery({ stage:"trashed",id: user?._id });
  const [deleteRestore] = useDeleteRestoreTaskMutation();

  const deleteRestoreHandler = async () => {
    try {
      // Call mutation based on type
      const res= await deleteRestore({ id: selected, actionType:type }).unwrap();
